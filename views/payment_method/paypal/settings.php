    ...
    <div class="col-xs-12"><h2 class="sln-box-title"><?php _e('Paypal account informations','salon-booking-system');?></h2></div>
        <div class="col-xs-12 col-sm-6 col-md-4 sln-input--simple">
            <?php $adminSettings->row_input_text('pay_paypal_email', __('Enter your PayPal e-mail address', 'salon-booking-system')); ?>
        ...
        <div class="col-xs-12 col-sm-6 col-md-5 sln-checkbox">
        	...
        	<p class="sln-input-help"><?php _e('Check this option to test PayPal payments<br /> using your PayPal Sandbox account.', 'salon-booking-system') ?></p>
        </div>

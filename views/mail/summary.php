                        ...
                        <tr>
                                ...
                                <table width="112" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td height="36" align="left" valign="top"
                                            style="font-family:Arial, Helvetica, sans-serif; font-size:18px; color:#666666; font-weight:bold;"><?php echo $plugin->format(
                                            )->date($booking->getDate()); ?></td>
                                    </tr>
                                    <tr>
                                        <td height="25" align="left" valign="top"
                            ...
                            <td width="194" align="center" valign="top" style="border-right:2px solid #f2f2f2;">
                                <table width="155" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <?php foreach ($plugin->getServices() as $service) : if ($booking->hasService(
                                        $service
                                    )
                                    ): ?>
                                        <tr>

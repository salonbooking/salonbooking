...
<p><strong>Please confirm or reject this booking from administration</strong></p>
<?php endif ?>
<a href="<?php echo admin_url() ?>/post.php?post=<?php echo $booking->getId() ?>&action=edit">View this booking in wordpress administration</a>
<?php

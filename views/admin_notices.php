<div id="sln-setting-error" class="updated settings-error">
    ...
    <?php _e('<p>A new <strong>"Salon"</strong> section has been created into the left sidebar<br/>
        ...
        Go to "Salon > Settings" section in order to set your own salon booking system</p>','sln');?>

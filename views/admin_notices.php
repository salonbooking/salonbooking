<div id="sln-setting-error" class="updated settings-error">
    <h3>Salon booking plugin has been activated</h3>

    <p>A new <strong>"Salon"</strong> section has been created into the left sidebar<br/>
        ...
        Go to "Salon > Settings" section in order to set your own salon booking system</p>
